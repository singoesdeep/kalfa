...
export function reviewPrompt(
  ...
  return [
    ...
    ``,
    `   **Before reporting that any file was weakened or modified, confirm it is`,
    `   actually in the diff.** Run \`git diff HEAD --name-only\` and check the name`,
    `   is listed. If it is not there, that file was NOT touched and there is`,
    `   nothing to report about it.`,
    ``,
    `   This instruction exists because it was got wrong in practice: asked to`,
    `   review a correct fix for a failing test, reviewers twice reported as a`,
    `   blocker that the test file had been weakened, when git showed it`,
